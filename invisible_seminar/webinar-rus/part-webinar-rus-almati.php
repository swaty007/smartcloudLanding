...
<section id="main-block" class="main-block">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <p class="blue-bullet">
                    Семинар &bull; 14 марта 2019 10:00 - 14:00 &bull; Алматы
                </p>
                <h1 class="title">
...
<section id="content-block" class="content-block">
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <p class="text">
                    ...
                    Во время семинара спикеры расскажут как именно это можно сделать, и так же покроют следующие темы:
                </p>
                <h3 class="sub-title small"></h3>
                <p class="description">
                    Как при помощи средств Microsoft Office сократить операционные затраты отдела продаж и дать возможность продавцам сфокусироваться на главном – непосредственно на продажах.                </p>
                <p class="description">
                    Как, не меняя персонал, качественно и количественно увеличить достигаемые показатели продаж путем изменения внутренних процессов и какие средства автоматизации могут в этом помочь?                </p>
                <p class="description">
                    Автоматический анализ команды продаж – кто мой лучший продавец и почему?
                </p>
                <p class="description">
                    «Механические продажи» и «вовлечение в продажу» - в чем отличие и как автоматизировать?
                </p>
                <p class="description">
                    Если CRM уже внедрена, как синхронизировать данные в CRM с реальной жизнью и как максимизировать ценность этих данных для процесса продаж?
                </p>
                ...
                <p class="text">
                    14 Марта 10:00 - 14:00
                </p>
                <p class="text">
                    Hotel Mercure Almaty City Center<br>
                    Адрес: проспект Абылай Хана 53, Алматы 050000, Казахстан<br>
                    Телефон: <a href="tel:+77273442850" style="text-decoration: none;">
                        +7 727 344 2850</a><br>
                </p>
            </div>
            <div class="col-md-5">
    ...
    font-size: 25px;
    font-weight: 300;text-align:center;" class="title">Форма регистрации</p>
                        <form>
                            <p class="input">
                                <label>
                            ...
                            <p class="input">
                                <label>
                                    ...
                                    <span class="label">Какая у вас CRM система?</span>
                                </label>
                            </p>
